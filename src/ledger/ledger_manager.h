...
namespace rexx {
	...
	class LedgerManager : public utils::Singleton<rexx::LedgerManager>,
		public rexx::TimerNotify,
		public rexx::StatusModule {
		friend class utils::Singleton<rexx::LedgerManager>;
	public:
