...
namespace rexx {
	...
	*/
	...
	const char *General::REXX_VERSION = "1.0.0.7";
	...
	const char *General::CONFIG_FILE = "config/rexx.json";
	const char *General::MONITOR_CONFIG_FILE = "config/monitor.json";
	const char *General::LOGGER_FILE = "log/rexx.log";
	...
	const char *General::CONTRACT_VALIDATOR_ADDRESS = "Rexxhri26SFgngMGgr1G5y7aSKK6G8TgDshVMSJ";
	const char *General::CONTRACT_FEE_ADDRESS = "RexxhrURD7w62kKiGuYhDouAuBRy6X7mimtsdmT";
