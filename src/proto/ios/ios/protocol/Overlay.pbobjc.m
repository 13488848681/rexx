  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "rexxVersion",
        .dataTypeSpecific.className = NULL,
        .number = Hello_FieldNumber_RexxVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Hello__storage_, rexxVersion),
        .flags = GPBFieldOptional,
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "rexxVersion",
        .dataTypeSpecific.className = NULL,
        .number = ChainStatus_FieldNumber_RexxVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(ChainStatus__storage_, rexxVersion),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
