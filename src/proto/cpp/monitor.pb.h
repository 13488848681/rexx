...
class RexxStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:monitor.RexxStatus) */ {
 public:
  RexxStatus();
  virtual ~RexxStatus();

  RexxStatus(const RexxStatus& from);

  inline RexxStatus& operator=(const RexxStatus& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const RexxStatus& default_instance();

  void Swap(RexxStatus* other);

  // implements Message ----------------------------------------------

  inline RexxStatus* New() const { return New(NULL); }

  RexxStatus* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const RexxStatus& from);
  void MergeFrom(const RexxStatus& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(RexxStatus* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static RexxStatus* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .monitor.GlueManager glue_manager = 1;
inline bool RexxStatus::has_glue_manager() const {
  return !_is_default_instance_ && glue_manager_ != NULL;
}
inline void RexxStatus::clear_glue_manager() {
  if (GetArenaNoVirtual() == NULL && glue_manager_ != NULL) delete glue_manager_;
  glue_manager_ = NULL;
}
inline const ::monitor::GlueManager& RexxStatus::glue_manager() const {
...
inline ::monitor::GlueManager* RexxStatus::mutable_glue_manager() {
...
inline ::monitor::GlueManager* RexxStatus::release_glue_manager() {
...
inline void RexxStatus::set_allocated_glue_manager(::monitor::GlueManager* glue_manager) {
...
// optional .monitor.PeerManager peer_manager = 2;
inline bool RexxStatus::has_peer_manager() const {
  return !_is_default_instance_ && peer_manager_ != NULL;
}
inline void RexxStatus::clear_peer_manager() {
  if (GetArenaNoVirtual() == NULL && peer_manager_ != NULL) delete peer_manager_;
  peer_manager_ = NULL;
}
inline const ::monitor::PeerManager& RexxStatus::peer_manager() const {
...
inline ::monitor::PeerManager* RexxStatus::mutable_peer_manager() {
...
inline ::monitor::PeerManager* RexxStatus::release_peer_manager() {
...
inline void RexxStatus::set_allocated_peer_manager(::monitor::PeerManager* peer_manager) {
