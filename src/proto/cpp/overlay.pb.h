...
class Hello : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.Hello) */ {
 public:
  ...
  void clear_rexx_version();
  static const int kRexxVersionFieldNumber = 4;
  const ::std::string& rexx_version() const;
  void set_rexx_version(const ::std::string& value);
  void set_rexx_version(const char* value);
  void set_rexx_version(const char* value, size_t size);
  ::std::string* mutable_rexx_version();
  ::std::string* release_rexx_version();
  void set_allocated_rexx_version(::std::string* rexx_version);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr rexx_version_;
...
inline void Hello::set_rexx_version(const ::std::string& value) {
...
inline void Hello::set_rexx_version(const char* value) {
...
inline void Hello::set_rexx_version(const char* value, size_t size) {
...
inline ::std::string* Hello::mutable_rexx_version() {
...
inline ::std::string* Hello::release_rexx_version() {
...
inline void Hello::set_allocated_rexx_version(::std::string* rexx_version) {
...
// optional string rexx_version = 4;
inline void ChainStatus::clear_rexx_version() {
  rexx_version_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& ChainStatus::rexx_version() const {
  // @@protoc_insertion_point(field_get:protocol.ChainStatus.rexx_version)
  return rexx_version_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void ChainStatus::set_rexx_version(const ::std::string& value) {
  
  rexx_version_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:protocol.ChainStatus.rexx_version)
}
inline void ChainStatus::set_rexx_version(const char* value) {
  
  rexx_version_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protocol.ChainStatus.rexx_version)
}
inline void ChainStatus::set_rexx_version(const char* value, size_t size) {
  
  rexx_version_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protocol.ChainStatus.rexx_version)
}
inline ::std::string* ChainStatus::mutable_rexx_version() {
  
  // @@protoc_insertion_point(field_mutable:protocol.ChainStatus.rexx_version)
  return rexx_version_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ChainStatus::release_rexx_version() {
  // @@protoc_insertion_point(field_release:protocol.ChainStatus.rexx_version)
  
  return rexx_version_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void ChainStatus::set_allocated_rexx_version(::std::string* rexx_version) {
  if (rexx_version != NULL) {
