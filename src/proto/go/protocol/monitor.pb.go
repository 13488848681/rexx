...
const (
	...
	MONITOR_MESSAGE_TYPE_MONITOR_MSGTYPE_REXX              MONITOR_MESSAGE_TYPE = 32
...
func (m *RexxStatus) Reset()         { *m = RexxStatus{} }
func (m *RexxStatus) String() string { return proto.CompactTextString(m) }
func (*RexxStatus) ProtoMessage()    {}
func (*RexxStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_monitor_2647886f338c3a47, []int{5}
}
func (m *RexxStatus) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RexxStatus.Unmarshal(m, b)
}
func (m *RexxStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RexxStatus.Marshal(b, m, deterministic)
}
func (dst *RexxStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RexxStatus.Merge(dst, src)
}
func (m *RexxStatus) XXX_Size() int {
	return xxx_messageInfo_RexxStatus.Size(m)
}
func (m *RexxStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_RexxStatus.DiscardUnknown(m)
}

var xxx_messageInfo_RexxStatus proto.InternalMessageInfo

func (m *RexxStatus) GetGlueManager() *GlueManager {
	if m != nil {
...
func (m *RexxStatus) GetPeerManager() *PeerManager {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*RexxStatus)(nil), "monitor.RexxStatus")
